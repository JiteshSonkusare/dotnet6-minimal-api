namespace KontofonMonitor.API.Application.Wrapper
{
    ...
    public class Result<T> : Result, IResult<T>
    {
        ...
        public static Result<T> Success(T data, int count)
        {
            return new Result<T> { Succeeded = true, Data = data, Count = count };
        }

        public static Result<T> Success(T data, int count, string message)
        {
            return new Result<T> { Succeeded = true, Data = data, Count = count, Messages = new List<string> { message } };
        }

        public static Result<T> Success(T data, int count, List<string> messages)
        {
            return new Result<T> { Succeeded = true, Data = data, Count = count, Messages = messages };
        }
        ...
        public static Task<Result<T>> SuccessAsync(T data, int count, string message)
        {
            return Task.FromResult(Success(data, count, message));
        }
    }
}
